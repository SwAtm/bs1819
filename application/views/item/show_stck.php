...
<?php
echo "<tr><td align=center bgcolor=white>".$item->code." ".$item->title." ".$item->rate."</td></tr></table>";
?>
...
echo "<tr><td width=10%>".$row['date']."</td><td width=70%>".$row['party']."</td><td width=10%>".$row['qty']."</td><td width=10%>".$row['balance']."</td></tr>";
endforeach;
