...
--
-- Host: localhost
-- Generation Time: Mar 09, 2019 at 06:31 PM
...
--
-- Table structure for table `op_invent`
--

CREATE TABLE IF NOT EXISTS `op_invent` (
`id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
...
--
-- Indexes for table `op_invent`
--
ALTER TABLE `op_invent`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `loc_item_cost` (`location_id`,`item_id`,`cost`), ADD KEY `location_id` (`location_id`), ADD KEY `item_id` (`item_id`);
...
ALTER TABLE `po_details`
 ADD PRIMARY KEY (`id`), ADD KEY `po_summ_id` (`po_summ_id`,`item_id`), ADD KEY `item_id` (`item_id`);
...
--
-- AUTO_INCREMENT for table `op_invent`
--
ALTER TABLE `op_invent`
...
--
-- Constraints for table `op_invent`
--
ALTER TABLE `op_invent`
ADD CONSTRAINT `op_invent_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
ADD CONSTRAINT `op_invent_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

--
-- Constraints for table `po_details`
--
ALTER TABLE `po_details`
ADD CONSTRAINT `po_details_ibfk_1` FOREIGN KEY (`po_summ_id`) REFERENCES `po_summary` (`id`),
ADD CONSTRAINT `po_details_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

--
-- Constraints for table `po_summary`
--
ALTER TABLE `po_summary`
ADD CONSTRAINT `po_summary_ibfk_1` FOREIGN KEY (`party_id`) REFERENCES `party` (`id`);
