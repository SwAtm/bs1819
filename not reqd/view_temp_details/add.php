...
echo "<tr><td>Discount</td><td>".form_input('discount',number_format($discount,2))."</td></tr>";
echo "<tr><td>Cash Discount</td><td>".form_input('cashdisc',number_format($cashdisc,2))."</td></tr>";
